...
OUTDIR="$ROOT/results/INFRA3/A2/$ARM/p${PSTR}/boot${BOOT_N}"; mkdir -p "$OUTDIR"
...
LAST_END_F="$ROOT/results/INFRA3/.last_boot_end"; NOW_T=$(date +%s)
...
date +%s > "$ROOT/results/INFRA3/.last_boot_end"   # B4: znacznik końca bootu (cooldown następnego)
